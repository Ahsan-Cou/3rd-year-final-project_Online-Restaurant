		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> El-Classico 2.0 Jail Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							...
							<p class="m-b-40">El-Classico 2.0 Jail Restaurant is serving a Authentic Food.And Restaurant's 
<br> 
			...
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Yamifood with El-Classico 2.0 Jail</strong></h1>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>El-Classico 2.0 Jail Restaurant</span></h1>
						<h4>Little Story</h4>
						<p> <font color="#00ced1">Restaurants in Comilla, Chilly Restaurants, Cafe spoon restaurants, Avengers restaurants, Kostory restaurants, El-classico Restaurants in Comilla, Comilla near me, El-Classico 2.0 Jail Restaurants in Comilla, </font>
 </p>
						<p> <font color="#00ced1">Cafe light house restaurant, Chilly restaurant, el-classico rastaurant, black&white restaurant, best party center, el-classico 2.0 jail </font> </p>
						<a class="btn btn-lg btn-circle btn-outline-new-white" href="#">Contact Us</a>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="images/place.jpg"  width="200%" height="200%" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">El-Classico 2.0 Jail Restaurent</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for El-Classico 2.0 Jail Restaurent Listed Here </p>
					</div>
				</div>
			</div>
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Rakibul</strong></h5>
