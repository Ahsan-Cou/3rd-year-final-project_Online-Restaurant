	...
	<form action="order.php" method="post">
		...
		<br>
			    ...
			    <tr align="center">
			    	...
			    	<td style="color: green;">  Enter your name  <br>
			    ...
			    <tr align="center">
			    	<td style="color: green;">   Enter Mobile no <br>
			    ...
			    <tr align="center">
			    	<td style="color: green;">   Enter Email address <br>
                ...
                <tr align="center">
                	<td style="color: green;"> Enter address <br>
